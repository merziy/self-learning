/* Solution modified from https://penti.org/~sederlok/misc/lang/c/the_c_programming_language_-_exercises/krx203.html */
...
long hchartoi (char hexdig, int post); /*converts hex to decimal knowing its 0 based place value*/
